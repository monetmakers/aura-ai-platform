...
const FontLink = () => (
  <link
    href="https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=Literata:ital,opsz,wght@0,7..72,400;0,7..72,500;1,7..72,400;1,7..72,600&display=swap"
    rel="stylesheet"
  />
);
...
const chatScripts = [
  ...
  },
  {
    ...
    messages: [
      ...
      { from: "bot",  text: "Most sink repairs run $80–$150. We give a fixed quote before starting — no surprises. I can send you our pricing guide if you'd like." },
    ]
  },
  {
  ...
  useEffect(() => {
    ...
    function showNext() {
      if (count >= script.messages.length) {
        setTimeout(() => {
          setScriptIdx(i => (i + 1) % chatScripts.length);
        }, 2400);
        return;
      }
    ...
    <div style={{
      ...
      <div style={{
        ...
        {script.messages.slice(0, visibleCount).map((msg, i) => (
          <ChatBubble key={`${scriptIdx}-${i}`} msg={msg} accentColor={script.color} isLast={i === visibleCount - 1} />
        ))}
        <div ref={bottomRef} />
      </div>
...
function ChatBubble({ msg, accentColor, isLast }) {
  const { displayed, done } = useTypewriter(
    msg.text, 22, msg.from === "bot" ? 300 : 0
  );
...
/* ─── Pricing card ─── */
function PricingCard({ plan, price, desc, features, highlight, color }) {
  return (
    <div style={{
      ...
      onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-4px)"; e.currentTarget.style.boxShadow = highlight ? "0 24px 64px rgba(245,158,11,0.18)" : "0 12px 40px rgba(0,0,0,0.4)"; }}
      onMouseLeave={e => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = highlight ? "0 16px 48px rgba(245,158,11,0.12)" : "none"; }}
    >
      {highlight && (
        <div style={{
        ...
        <nav className={`lnav ${scrolled ? "scrolled" : ""}`}>
          <div className="lnav-inner">
            ...
            <div className="lnav-links">
              ...
              <a href="#pricing" className="lnav-link">Pricing</a>
            </div>
            <div className="lnav-actions">
              <button className="lnav-ghost">Sign in</button>
              <button className="lnav-cta">Start free →</button>
            </div>
          </div>
        </nav>
        ...
        <div className="landing-scroll">
            ...
            <div className="hero-inner">
              <div className="hero-left">
                <div className="hero-eyebrow">
                  <span>✦</span> Trusted by 2,400+ local businesses
                </div>
                ...
                <p className="hero-sub">
                  Give your business an AI agent that talks exactly like your brand,
                  knows everything about your products, and deploys to every channel
                  in one click — no code, no complexity.
                </p>
                <div className="hero-actions">
                  <button className="hero-cta">Build your agent free →</button>
                  <button className="hero-ghost">See a demo ▶</button>
                </div>
                <div className="hero-trust">
                  ...
                  <span className="trust-text">Join 2,400+ businesses already using Aura</span>
                </div>
              </div>
              ...
              <div className="hero-right">
                ...
                <div className="float-badge float-1">
                  ...
                  <div>
                    <div style={{ fontSize: "0.72rem", fontWeight: 700, color: "#f5e6c8" }}>Instant deploy</div>
                    <div style={{ fontSize: "0.62rem", color: "#6b6355" }}>Web · FB · WhatsApp</div>
                  </div>
                </div>
                <div className="float-badge float-2">
                  <div style={{ fontSize: "1rem" }}>📈</div>
                  <div>
                    <div style={{ fontSize: "0.72rem", fontWeight: 700, color: "#34d399" }}>+94% CSAT</div>
                    <div style={{ fontSize: "0.62rem", color: "#6b6355" }}>avg. improvement</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="section" id="features">
            <div className="section-inner">
              ...
              <h2 className="section-title">Everything your agent needs<br /><em>to sound like you</em></h2>
              <p className="section-sub">Three pillars that make Aura agents genuinely useful — not just another chatbot.</p>
                ...
                {[
                  {
                    ...
                    desc: "Train your agent on your actual language. Upload past conversations, your FAQ, even how you write emails — the agent mirrors your tone exactly.",
                    tags: ["Tone matching", "Custom phrases", "Personality config"],
                  },
                  {
                    icon: "⊟", color: "#60a5fa",
                    title: "Deep Knowledge Base",
                    desc: "Upload PDFs, menus, price lists, policies. Your agent answers specific questions about your business — no hallucinations, no generic responses.",
                    tags: ["PDF upload", "Real-time sync", "Product catalogue"],
                  },
                  {
                    icon: "⊕", color: "#f472b6",
                    title: "One-Click Deployment",
                    desc: "Publish to your website, Facebook Messenger, WhatsApp Business, and Instagram DMs simultaneously — one embed code, one dashboard.",
                    tags: ["Website widget", "Messenger", "WhatsApp"],
                  },
                  {
                    icon: "◉", color: "#34d399",
                    title: "Continuous Learning",
                    desc: "Every conversation is an insight. Aura tracks unresolved questions and suggests knowledge gaps so your agent improves week by week.",
                    tags: ["AI insights", "Gap detection", "Auto-improve"],
                  },
                ].map((f, i) => (
          ...
          <section className="section alt-bg" id="how">
            <div className="section-inner">
              ...
              <h2 className="section-title">Up and running<br /><em>in under 15 minutes</em></h2>

              <div className="steps-row">
                {[
                  { n: "01", color: "#f59e0b", title: "Train your agent", desc: "Upload your documents, FAQs, and product info. Add your brand's tone and voice guidelines." },
                  { n: "02", color: "#60a5fa", title: "Test & refine", desc: "Use the live playground to chat with your agent. Tweak responses until it sounds exactly like you." },
                  { n: "03", color: "#34d399", title: "Deploy everywhere", desc: "Grab your embed code and paste it into your website. Connect WhatsApp and Messenger in two clicks." },
                ].map((s, i) => (
          ...
          <section className="section" id="pricing">
            <div className="section-inner">
              ...
              <p className="section-sub">Start free. Scale as your business grows.</p>
              <div className="pricing-row">
                <PricingCard
                  plan="Starter" price="$0" color="#6b6355"
                  desc="Perfect for testing the waters"
                  features={["1 AI agent","100 conversations/mo","Website widget only","Community support"]}
                />
                <PricingCard
                  plan="Growth" price="$49" color="#f59e0b"
                  desc="For businesses ready to scale" highlight
                  features={["3 AI agents","2,000 conversations/mo","All channels (Web, FB, WhatsApp)","AI Insights dashboard","Priority support"]}
                />
                <PricingCard
                  plan="Pro" price="$129" color="#60a5fa"
          ...
          <section className="footer-cta">
            ...
            <div className="section-inner" style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
              ...
              <h2 className="section-title" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
                Your customers are waiting.<br /><em>Don't make them wait.</em>
              </h2>
              <p className="section-sub" style={{ maxWidth: 480, margin: "0 auto 2.5rem" }}>
                Join 2,400+ businesses using Aura to deliver instant, human-quality customer support around the clock.
              </p>
              <button className="hero-cta" style={{ margin: "0 auto" }}>Build your agent free →</button>
            </div>
          </section>
          ...
          <footer className="footer">
            ...
            <div style={{ fontSize: "0.72rem", color: "#4a4035" }}>© 2026 Aura. All rights reserved.</div>
          </footer>
...
const css = `
  ...
  /* PRICING */
  .pricing-row {
    display: flex; gap: 1.2rem; align-items: stretch; flex-wrap: wrap;
  }
